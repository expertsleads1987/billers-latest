...
import com.experts.core.biller.statemachine.api.vertxloader.data.CustomerRepositoryImpl;
...
public class MongoVerticle extends AbstractVerticle {
	...
	public void start() throws Exception {
		...
		retriever.getConfig(conf -> {
			...
			ProxyHelper.registerService(CustomerRepository.class, vertx, service, "com.experts.core.biller.statemachine.api.customer-service");
		});
	}
