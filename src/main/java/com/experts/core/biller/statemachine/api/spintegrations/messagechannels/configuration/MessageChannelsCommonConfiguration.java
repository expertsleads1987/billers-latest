...
/**
 * Beans used in the {@code MessageChannelsCommonBillerCore} tests.
 *
 * @author Ivan Krizsan
 */
@Configuration
public class MessageChannelsCommonConfiguration implements SpringIntegrationBillerConstants {
