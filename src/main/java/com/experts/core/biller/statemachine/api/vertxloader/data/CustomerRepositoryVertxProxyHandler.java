...
public class CustomerRepositoryVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        case "save": {
          service.save(json.getJsonObject("customer") == null ? null : new com.experts.core.biller.statemachine.api.vertxloader.data.Customer(json.getJsonObject("customer")), res -> {
            if (res.failed()) {
