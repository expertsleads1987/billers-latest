package com.experts.core.biller.statemachine.api.vertxloader;

import com.experts.core.biller.statemachine.api.vertxloader.client.AccountClient;
import com.experts.core.biller.statemachine.api.vertxloader.data.Customer;
import com.experts.core.biller.statemachine.api.vertxloader.data.CustomerRepository;
...
public class CustomerServer extends AbstractVerticle {
	...
	public void start() throws Exception {
		...
		CustomerRepository repository = CustomerRepository.createProxy(vertx, "com.experts.core.biller.statemachine.api.customer-service");
		  
		Router router = Router.router(vertx);
		router.route("/com/experts/core/biller/statemachine/api/vertxloader/*").handler(ResponseContentTypeHandler.create());
		router.route(HttpMethod.POST, "/com/experts/core/biller/statemachine/api/vertxloader").handler(BodyHandler.create());
		router.get("/com/experts/core/biller/statemachine/api/vertxloader/:id").produces("application/json").handler(rc -> {
		...
		router.get("/com/experts/core/biller/statemachine/api/vertxloader/name/:name").produces("application/json").handler(rc -> {
		...
		router.get("/com/experts/core/biller/statemachine/api/vertxloader").produces("application/json").handler(rc -> {
		...
		router.post("/com/experts/core/biller/statemachine/api/vertxloader").produces("application/json").handler(rc -> {
		...
		router.delete("/com/experts/core/biller/statemachine/api/vertxloader/:id").handler(rc -> {
