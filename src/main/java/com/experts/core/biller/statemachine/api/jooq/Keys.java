...
import com.experts.core.biller.statemachine.api.jooq.tables.records.ModifiedEntityRecord;
import com.experts.core.biller.statemachine.api.jooq.tables.records.PayStateRecord;
import com.experts.core.biller.statemachine.api.jooq.tables.records.PaymentRecord;
...
import com.experts.core.biller.statemachine.api.jooq.tables.records.TxAccountRecord;
import com.experts.core.biller.statemachine.api.jooq.tables.records.TxKullaniciRolRecord;
import com.experts.core.biller.statemachine.api.jooq.tables.records.TxMenuRecord;
import com.experts.core.biller.statemachine.api.jooq.tables.records.TxPageRecord;
import com.experts.core.biller.statemachine.api.jooq.tables.records.TxRolRecord;
import com.experts.core.biller.statemachine.api.jooq.tables.records.TxRolYetkiRecord;
import com.experts.core.biller.statemachine.api.jooq.tables.records.TxUserRecord;
import com.experts.core.biller.statemachine.api.jooq.tables.records.TxYetkiRecord;
...
public class Keys {
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<CustomtrackingrevisionentityRecord> CUSTOMTRACKINGREVISIONENTITY_PKEY = Internal.createUniqueKey(Customtrackingrevisionentity.CUSTOMTRACKINGREVISIONENTITY, "customtrackingrevisionentity_pkey", Customtrackingrevisionentity.CUSTOMTRACKINGREVISIONENTITY.CUSTOMID);
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<ModifiedEntityRecord, CustomtrackingrevisionentityRecord> MODIFIED_ENTITY__FK401W1WJ7GYCETRYWNXRIN3FEG = Internal.createForeignKey(com.experts.core.biller.statemachine.api.jooq.Keys.CUSTOMTRACKINGREVISIONENTITY_PKEY, ModifiedEntity.MODIFIED_ENTITY, "modified_entity__fk401w1wj7gycetrywnxrin3feg", ModifiedEntity.MODIFIED_ENTITY.REVISION_ID);
        ...
        public static final ForeignKey<PaymentRecord, TransactionRecord> PAYMENT__FKH1BB7AUFNADO7E3FEUJSQJ75Q = Internal.createForeignKey(com.experts.core.biller.statemachine.api.jooq.Keys.TRANSACTION_PKEY, Payment.PAYMENT, "payment__fkh1bb7aufnado7e3feujsqj75q", Payment.PAYMENT.TRANSACTION_ID);
        ...
        public static final ForeignKey<TransactionRecord, TransactionstatusRecord> TRANSACTION__FK4PIAQKVC5TVNEWT8B53YI687A = Internal.createForeignKey(com.experts.core.biller.statemachine.api.jooq.Keys.TRANSACTIONSTATUS_PKEY, Transaction.TRANSACTION, "transaction__fk4piaqkvc5tvnewt8b53yi687a", Transaction.TRANSACTION.STATUS_ID);
        public static final ForeignKey<TxKullaniciRolRecord, TxRolRecord> TX_KULLANICI_ROL__FKJSJV5OO3OJOTN4B7FXMKHJK87 = Internal.createForeignKey(com.experts.core.biller.statemachine.api.jooq.Keys.TX_ROL_PKEY, TxKullaniciRol.TX_KULLANICI_ROL, "tx_kullanici_rol__fkjsjv5oo3ojotn4b7fxmkhjk87", TxKullaniciRol.TX_KULLANICI_ROL.ROLE_ID);
        public static final ForeignKey<TxKullaniciRolRecord, TxUserRecord> TX_KULLANICI_ROL__FKK3F8TSI5VN6W3QSRRK1YWG5QJ = Internal.createForeignKey(com.experts.core.biller.statemachine.api.jooq.Keys.TX_USER_PKEY, TxKullaniciRol.TX_KULLANICI_ROL, "tx_kullanici_rol__fkk3f8tsi5vn6w3qsrrk1ywg5qj", TxKullaniciRol.TX_KULLANICI_ROL.USER_ID);
        public static final ForeignKey<TxMenuRecord, TxPageRecord> TX_MENU__FK7THA45RNUYC3K8TM8ODOP0LGI = Internal.createForeignKey(com.experts.core.biller.statemachine.api.jooq.Keys.TX_PAGE_PKEY, TxMenu.TX_MENU, "tx_menu__fk7tha45rnuyc3k8tm8odop0lgi", TxMenu.TX_MENU.PAGE_ID);
        public static final ForeignKey<TxMenuRecord, TxMenuRecord> TX_MENU__FKMFGJ0GN9Y8PNY1RD31OCGPWB7 = Internal.createForeignKey(com.experts.core.biller.statemachine.api.jooq.Keys.TX_MENU_PKEY, TxMenu.TX_MENU, "tx_menu__fkmfgj0gn9y8pny1rd31ocgpwb7", TxMenu.TX_MENU.PARENT_ID);
        public static final ForeignKey<TxRolYetkiRecord, TxRolRecord> TX_ROL_YETKI__FK86F9OLGXPYWSWCM7CTBOOBJDE = Internal.createForeignKey(com.experts.core.biller.statemachine.api.jooq.Keys.TX_ROL_PKEY, TxRolYetki.TX_ROL_YETKI, "tx_rol_yetki__fk86f9olgxpywswcm7ctboobjde", TxRolYetki.TX_ROL_YETKI.ROLE_ID);
        public static final ForeignKey<TxRolYetkiRecord, TxYetkiRecord> TX_ROL_YETKI__FK2WVPJW8UEJY8MM7H4Q6M6YKUX = Internal.createForeignKey(com.experts.core.biller.statemachine.api.jooq.Keys.TX_YETKI_PKEY, TxRolYetki.TX_ROL_YETKI, "tx_rol_yetki__fk2wvpjw8uejy8mm7h4q6m6ykux", TxRolYetki.TX_ROL_YETKI.YETKI_ID);
        public static final ForeignKey<TxYetkiRecord, TxMenuRecord> TX_YETKI__FKI36LTSB5IU3TK4YLVDJOGLS4A = Internal.createForeignKey(com.experts.core.biller.statemachine.api.jooq.Keys.TX_MENU_PKEY, TxYetki.TX_YETKI, "tx_yetki__fki36ltsb5iu3tk4ylvdjogls4a", TxYetki.TX_YETKI.MENU_ID);
