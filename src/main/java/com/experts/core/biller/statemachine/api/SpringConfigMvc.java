...
@Configuration
@EnableWebMvc
@ComponentScan(basePackageClasses = { PaymentNotificationController.class , PaymentBillPullController.class , PaymentServiceController.class , PaymentPrePaidController.class })
@Import({PaymentBillPullController.class , PaymentBillPullController.class , PaymentNotificationController.class , PaymentPrePaidController.class , PaymentServiceController.class})
public class SpringConfigMvc extends WebMvcConfigurerAdapter /*implements WebApplicationInitializer*/ {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema billpull) {
        ...
        wsdl11Definition.setTargetNamespace("http://localhost:3070/ws/billpull");
