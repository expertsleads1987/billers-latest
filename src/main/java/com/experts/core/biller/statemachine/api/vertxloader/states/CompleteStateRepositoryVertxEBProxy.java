...
public class CompleteStateRepositoryVertxEBProxy implements CompleteStateRepository {
  ...
  public CompleteStateRepositoryVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public CompleteStateRepositoryVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public CompleteStateRepository save(CompletedState completedState, Handler<AsyncResult<CompletedState>> resultHandler) {
    ...
    _json.put("completedState", completedState == null ? null : completedState.toJson());
    ...
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        ...
        resultHandler.handle(Future.succeededFuture(res.result().body() == null ? null : new CompletedState(res.result().body())));
                      }
    });
    return this;
  }
      ...
      if (res.failed()) {
        ...
        resultHandler.handle(Future.succeededFuture(res.result().body().stream()
            .map(o -> { if (o == null) return null;
                        return o instanceof Map ? new CompletedState(new JsonObject((Map) o)) : new CompletedState((JsonObject) o);
                 })
