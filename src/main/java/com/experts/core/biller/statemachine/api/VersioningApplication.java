...
import com.experts.core.biller.statemachine.api.activemq.standers.config.AtomikosJtaPlatformFactoryBean;
...
import com.experts.core.biller.statemachine.api.activemq.standers.spring.configuration.ApplicationEnvironment;
import com.experts.core.biller.statemachine.api.activemq.standers.spring.configuration.BasicHibernateProperties;
...
import com.experts.core.biller.statemachine.api.order.OrderStateMachineConfiguration;
...
@ComponentScan(basePackages = {"com.experts.core.biller.statemachine.api",
        ...
        "com.experts.core.biller.statemachine.api.order",
        "com.experts.core.biller.statemachine.api.persist",
        "com.experts.core.biller.statemachine.api.transitions",
        "com.experts.core.biller.statemachine.api.vertxloader.data",
        ...
        , AtomikosJtaPlatformFactoryBean.class, JdbcTemplateUtils.class, PaymentNotificationCreationStructure.class, ApplicationEnvironment.class, AtomikosJtaPlatformFactoryBean.class, CustomerConfig.class, OrderStateMachineConfiguration.class
        ...
        ReadyToUseTransitionProcessBean.class,
        TransitionCancelBean.class,
        TransitionExecutionBean.class, AuthServer.class, WebSecurityConfig.class, CustomerConfig.class, MacAddressValidatorHandler.class, BasicHibernateProperties.class, XAPublisherTemplate.class, JDBCInMemory.class, GenerateKeysService.class, AsymmetricCryptographyService.class, EncryptByPkService.class, PaymentNotificationCreationStructure.class, WebApplicationInitializer.class, BillPullCreationStructure.class, SOAPSecurityHandler.class, SpringConfigMvc.class, HeaderModifierAdvice.class, UserDetailsServiceImpl.class, WebSecurityConfig.class, PaymentBillPullController.class, IInquiryServiceController.class, PaymentNotificationController.class, PaymentServiceController.class,
...
@EntityScan(basePackageClasses = {CompletedState.class, InitialState.class,
        Payment.class,
        PaymentStatus.class,
        PayState.class,
        ProcessState.class, Roles.class, Tasks.class, TaskVariables.class,
        Transaction.class, TransactionStatus.class, Users.class, WaitingState.class, IInquiryServiceController.class
...
*/
        ...
        dataRegionConfiguration.setInitialSize(4L *1024  * 1024 * 1024);
        dataRegionConfiguration.setMaxSize(12L * 1024 * 1024 * 1024);
