...
public interface ITokenService {
    ...
    @RequestWrapper(localName = "ValidateToken", targetNamespace = "http://tempuri.org/", className = "generated.token.cxf.ws.ValidateToken")
    @ResponseWrapper(localName = "ValidateTokenResponse", targetNamespace = "http://tempuri.org/", className = "generated.token.cxf.ws.ValidateTokenResponse")
    ...
    @RequestWrapper(localName = "Authenticate", targetNamespace = "http://tempuri.org/", className = "generated.token.cxf.ws.Authenticate")
    @ResponseWrapper(localName = "AuthenticateResponse", targetNamespace = "http://tempuri.org/", className = "generated.token.cxf.ws.AuthenticateResponse")
    @WebResult(name = "AuthenticateResult", targetNamespace = "http://tempuri.org/")
    public generated.token.cxf.ws.AuthenticateResponse.AuthenticateResult authenticate(
