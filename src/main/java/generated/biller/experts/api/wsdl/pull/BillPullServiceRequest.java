...
@XmlRootElement(name = "BillPullServiceRequest")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType( propOrder = {"acctInfo","billingNo","billNo","serviceType","payerInfo","idType","id","nation","name","phone","address","email","joebppsno"})
