...
@XmlType(name = "BillPullServiceResponse", propOrder = {"resCount","billRec","billingNo","billNo","result","errorCode","errorDesc","serverity","accInfo","billStatus","dueAmount","currency","issueDate","openDate","dueDate","expiryDate","closeDate","serviceType","billType","pmtConst","allowPart","lower","upper","subPmts","subPmt","amount","bankCode","accNo"})
