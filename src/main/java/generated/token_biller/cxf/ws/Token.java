 ...
 * 2018-08-16T17:54:11.729+03:00
 * Generated source version: 3.2.5
 *
 */
@WebServiceClient(name = "Token",
                  wsdlLocation = "http://40.113.2.64:6014/Token.svc?wsdl",
...
public class Token extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://40.113.2.64:6014/Token.svc?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Token.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://40.113.2.64:6014/Token.svc?wsdl");
        }
        WSDL_LOCATION = url;
    }
